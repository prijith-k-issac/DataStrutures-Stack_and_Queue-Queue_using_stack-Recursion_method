...
class Queue:
    def __init__(self):
        # using one stack for the operations
        self.stack = []
    ...
    # Note: here we are using 2 stacks again but instead of explicitly define the second stack,
    # we use the call-stack of program(stack memory or execution task)
    def dequeue(self):
        ...
        # this is what need for queue's dequeue operation
        if len(self.stack) == 1:
        ...
        # this is the item we are looking for (this is what have
        # been popped off in the stack.size() == 1 section)
